...
<div id="logo">
	...
	<tr>
	<td>
		<img src="images/saree3.jpg" alt="Img" width="300" height="450"/></td>
		<td><h2>Yellow pearl Indian saree</h2>
		<p>Rs.7500.00<br><!--UK Size<br>
		<select name="UKSize">
...
<div class="form-input">
						...
						<input type="hidden" name="type" value="GS003" />
